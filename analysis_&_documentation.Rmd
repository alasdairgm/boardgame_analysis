...
Cluster 1 seems to represent the games that can accommodate medium-sized groups that I don't enjoy very much.

Cluster 2 seems to represent the party games that can play with large groups that I enjoy very much - e.g. Wavelength.

Cluster 3 contains those games for smaller groups that I find pretty good.

Cluster 4 contains the games for the smallest groups that I find excellent.
...
* the difficulty has a negative relationship with my rating (+ 1 in difficulty/weight leads to + 0.97 in my rating)
